    ...
    class Meta:
        ...
        widgets = {
            "transaction_type": forms.Select(
                attrs={"class": "form-select", "id": "transactionType"}
            ),
            "account": forms.Select(attrs={"class": "form-select", "id": "account"}),
...
class AccountForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "account_number": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "e.g., 1234567890"}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["account_number"].help_text = (
            "optional: Enter your bank account number for reference"
        )
        ...
        self.fields["account_number"].help_text = (
            "Leave blank to auto-generate a unique account number"
        )
        self.fields["initial_balance"].help_text = (
            "Enter the current balance of this account"
        )
        self.fields["bank_name"].help_text = (
            "Optional: Name of the bank or financial institution"
        )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if user:
            self.fields["category"].queryset = Category.objects.filter(
                user=user, category_type__name="expense"
            )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "icon": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "e.g., 🍽️, 🚗, 💰"}
            ),
